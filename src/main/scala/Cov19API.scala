...
object Server extends Directives with JsonSupport {
  ...
  val confirmedDesc: (Cov19DayCountryInfo, Cov19DayCountryInfo) => Boolean = (el1: Cov19DayCountryInfo, el2: Cov19DayCountryInfo) => LocalDate.parse(el1.Date, inFormatter).isBefore(LocalDate.parse(el2.Date, inFormatter)) | (el1.NewConfirmed > el2.NewConfirmed & LocalDate.parse(el1.Date, inFormatter).isEqual(LocalDate.parse(el2.Date, inFormatter)))
  ...
  val deathsDesc: (Cov19DayCountryInfo, Cov19DayCountryInfo) => Boolean = (el1: Cov19DayCountryInfo, el2: Cov19DayCountryInfo) => LocalDate.parse(el1.Date, inFormatter).isBefore(LocalDate.parse(el2.Date, inFormatter)) | (el1.NewDeaths > el2.NewDeaths & LocalDate.parse(el1.Date, inFormatter).isEqual(LocalDate.parse(el2.Date, inFormatter)))
  val recoveredAsc: (Cov19DayCountryInfo, Cov19DayCountryInfo) => Boolean = (el1: Cov19DayCountryInfo, el2: Cov19DayCountryInfo) => LocalDate.parse(el1.Date, inFormatter).isBefore(LocalDate.parse(el2.Date, inFormatter)) | (el1.NewRecovered < el2.NewRecovered & LocalDate.parse(el1.Date, inFormatter).isEqual(LocalDate.parse(el2.Date, inFormatter)))
  val recoveredDesc: (Cov19DayCountryInfo, Cov19DayCountryInfo) => Boolean = (el1: Cov19DayCountryInfo, el2: Cov19DayCountryInfo) => LocalDate.parse(el1.Date, inFormatter).isBefore(LocalDate.parse(el2.Date, inFormatter)) | (el1.NewRecovered > el2.NewRecovered & LocalDate.parse(el1.Date, inFormatter).isEqual(LocalDate.parse(el2.Date, inFormatter)))
  val activeAsc: (Cov19DayCountryInfo, Cov19DayCountryInfo) => Boolean = (el1: Cov19DayCountryInfo, el2: Cov19DayCountryInfo) => LocalDate.parse(el1.Date, inFormatter).isBefore(LocalDate.parse(el2.Date, inFormatter)) | (el1.Active < el2.Active & LocalDate.parse(el1.Date, inFormatter).isEqual(LocalDate.parse(el2.Date, inFormatter)))
  val activeDesc: (Cov19DayCountryInfo, Cov19DayCountryInfo) => Boolean = (el1: Cov19DayCountryInfo, el2: Cov19DayCountryInfo) => LocalDate.parse(el1.Date, inFormatter).isBefore(LocalDate.parse(el2.Date, inFormatter)) | (el1.Active > el2.Active & LocalDate.parse(el1.Date, inFormatter).isEqual(LocalDate.parse(el2.Date, inFormatter)))
